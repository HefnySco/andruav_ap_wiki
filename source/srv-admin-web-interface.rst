...
.. image:: https://raw.githubusercontent.com/DroneEngage/droneengage_authenticator/refs/heads/release/wiki/images/_new_airgap_auth_site.png
   :height: 400px
   :align: center
   :alt: Server Status Page
...
- :ref:`srv-authentication` - Authentication server setup and configuration
- :ref:`srv-communication` - Communication server documentation
- :ref:`srv-index` - Server installation overview
