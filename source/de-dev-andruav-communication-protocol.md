...
![Andruav Communication Message Protocol](./images/message_structure.png)
...
> **Important:**
>
> Communication Protocol between Communicator and other unit module is called [de-dev-databus](de-dev-databus.md)
...
1. **'_AGN_':** all units in the system. i.e. units under the same account and group.

2. **'_GCS_':** all GCS in the system. i.e. units under the same account and group.

3. **'_GD_':** all GCS & units.
...
see: [js_andruav_chat_server.js function fn_parseMessage](https://github.com/DroneEngage/droneengage_server/blob/9f8527be7806771cd4b15f2c2b56ad32ae77c98c/server/js_andruav_chat_server.js#L199/)
