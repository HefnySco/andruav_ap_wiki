...
#. What is Web-Plugin
    Web Plugin is a small appplication that can run on Windows or Ubuntu. It allows you to connect Andruav WebClient to Mission Planner, QGround Control or any GCS without the need to use Andruav GCS mobile app. You can use Telemetry directly from Web. Please check :ref:`webclient-webplugin` for more details.
